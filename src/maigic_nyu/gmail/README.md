...
This project is currently under active development. Several aspects are still being refined:

- Docstrings are intentionally marked as "TODO" as we are finalizing the API design
- Type hints currently use Any as placeholder until we establish concrete types
- Additional features and improvements are planned
- Test coverage is being expanded
- Documentation will be enhanced as the API stabilizes
