...
def trello_manager():
    ...
    with patch.dict('os.environ', {
        ...
        with patch('src.trello.trello_manager.load_dotenv'):  # Mock load_dotenv
...
def test_add_attachment(trello_manager, mock_response):
...
def test_create_checklist(trello_manager):
...
def test_add_checklist_item(trello_manager, mock_response):
...
def test_update_card_due_date(trello_manager, mock_response):
...
def test_validate_board_access(trello_manager, mock_response):
    """Test board access validation"""
    with patch('requests.request', return_value=mock_response):
        assert trello_manager.validate_board_access("board123") is True

    with patch('requests.request', side_effect=TrelloAPIError):
...
def test_integration_create_card():
...
def test_get_full_board_info_success(trello_manager):
...
def test_get_full_board_info_failure(trello_manager):
...
def test_get_lists_success(trello_manager):
...
def test_get_lists_failure(trello_manager):
...
def test_get_list_name_success(trello_manager):
...
def test_get_list_name_failure(trello_manager):
...
def test_create_a_list_success(trello_manager):
...
def test_create_a_list_failure(trello_manager):
...
def test_add_comment_to_card_success(trello_manager):
...
def test_add_comment_to_card_failure(trello_manager):
...
def test_add_label_to_card_success(trello_manager):
...
def test_add_label_to_card_failure(trello_manager):
...
def test_move_card_success(trello_manager):
...
def test_move_card_failure(trello_manager):
...
def test_archive_card_success(trello_manager):
...
def test_archive_card_failure(trello_manager):
...
def test_make_request_network_error(trello_manager):
...
def test_make_request_timeout(trello_manager):
...
def test_make_request_retry_success(trello_manager, mock_response):
